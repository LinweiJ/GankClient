...
import com.wega.gankclient.home.android.AndroidModel;
...
public class IOSPresenter implements IOSContract.Presenter{
    ...
    private final IOSContract.Model mModel;
    ...
    public void refreshList() {
        Observable<GankBean> android = mModel.getIOS(mPage_rows, 1);
    ...
    public void loadMoreList(int page) {
        Observable<GankBean> android = mModel.getIOS(mPage_rows, page);
        android.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<GankBean>() {
                    Disposable mDisposable;
